<div>
    <div class="grid grid-cols-8 gap-0">
        ...
        <!-- header end -->
        <!-- side bar section -->
        <div class="col-span-2 p-4 h-full bg-gray-200" style=" border-right: solid 1px green; height:600px">
            @foreach($users as $user)
            <p class="p-2"><a href="{{ route('chat', $user->id) }}">{{ $user->name }}</a></p>
            @endforeach
        </div>
        <!-- body section -->
        <div class="col-span-6 p-4 bg-gray-100">
            ...
            <form wire:submit="sendMessage()">
                <div class="fixed flex justify-between bg-green-100" style="bottom: 0px; width: 73%;">
                    <textarea
